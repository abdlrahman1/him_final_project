...
<i class="fa-solid fa-xmark" id="remove_mark"></i>
<h1> sign up</h1>
<div class = "icons"> 
...
<input type="password" class="passoword_input" placeholder="password"name="password">
<input type="file"name="img">
</div>
<div class = "login_links">
<a href = "register"> already have an account?</a>
</div>
<div class = "login_btn"> <button type = "submit"name="btn"> SIGN UP</button></div>
</div>
</form>
</body>
</html>
